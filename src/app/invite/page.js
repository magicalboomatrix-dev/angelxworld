...
export default function DemoPage() {
  ...
  style={{'height': '100%','overflow': 'auto','scrollbarWidth':'thin', 'scrollbarColor':'transparent transparent'}}>
    ...
    <div className="login-bx" style={{"margin":"0 0 0 0",padding: 0}}><button className="login-btn open-btn" onClick={() => setIsOpen(true)} style={{width:"100%"}}>Invite Friends</button></div>
